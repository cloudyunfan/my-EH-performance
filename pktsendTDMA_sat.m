function [ pl,ps,outcome,CHN_sta_f,Succ_TX_flag,channelslt,E_ex,E_nodebuf,B_nodebuf] = pktsendTDMA_sat( CHNbefore_leng,CHNafter_leng,CHN_sta_ini,slotNO,Pu,Pd,channelslt,E_nodebuf,B_nodebuf)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%input:
